 ...
 *   using the `setMerkleRoot` function defined in BearCoffee.sol contract. For this script to work your contract
 ...
 */
 ...
 async function main() {
   const nftFactory = await hre.ethers.getContractFactory('BearCoffee')
   const nftContract = await nftFactory.attach(
     '0xa3888dB57F246f0C414cc122269Bc994C32a1b9a' // Deployed contract address
   )
